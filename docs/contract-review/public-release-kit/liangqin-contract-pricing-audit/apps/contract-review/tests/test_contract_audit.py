        ...
        job = JOB_MODELS.ReviewJob(
            ...
            assets=[
                JOB_MODELS.SourceAsset(
                    ...
                    role_hint="primary_contract",
                    text_preview=(
                        "演示合同 1.1甲方委托乙方定制家具（详见附件《定制清单及设计图纸》），"
        ...
        job = JOB_MODELS.ReviewJob(
            ...
            assets=[
                JOB_MODELS.SourceAsset(
                    ...
                    role_hint="primary_contract",
                    text_preview=(
                        "附件： 产品名称 产品编号 材质 数量 费用合计（元） 其他衣柜 20990090003001 北美黑胡桃木 1 43708 "
    ...
    def test_keeps_native_contract_total_when_ocr_markdown_only_covers_attachment_pages(self) -> None:
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            markdown_path.write_text(
                "附件： 产品名称 产品编号 材质 数量 费用合计（元） 其他餐边柜 20990080013001 北美白橡木 1 31631 "
                "定制组合餐边柜 20990080013002 北美白橡木 1 50828 合计 82459 折扣 98折 折扣后合计 80809",
                encoding="utf-8",
            )
            job = JOB_MODELS.ReviewJob(
                ...
                assets=[
                    JOB_MODELS.SourceAsset(
                        ...
                        role_hint="primary_contract",
                        text_preview=(
                            "演示合同 1.1甲方委托乙方定制家具，合同总 金额为人民币80809元。"

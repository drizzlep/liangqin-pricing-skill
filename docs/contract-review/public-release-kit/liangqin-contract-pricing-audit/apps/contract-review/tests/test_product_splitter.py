...
class ProductSplitterTests(unittest.TestCase):
    def test_extract_product_line_items_ignores_trailing_contract_declaration_pages(self) -> None:
        preview = (
            "第13页 20990010004演示合同 附件： 产品名称 产品编号 材质 数量 费用合计（元） "
            "经典床头柜 120990010004001 北美樱桃木 1 1780 合计 1780 "
            "第14页 儿童房 经典床头柜 1 209900100 04001北美樱桃木 无色哑光木蜡油尺寸 长：450mm 宽：400mm 高：500mm "
    ...
    def test_extract_product_line_items_from_multi_product_preview(self) -> None:
        preview = (
            "第13页 20990020001演示合同 附件： 产品名称 产品编号 材质 数量 费用合计（元） "
            "其他斗柜 20990020001001 北美黑胡桃木 1 12400 "
            "经典床头柜 320990020001002 北美黑胡桃木 1 2580 合计 14980 "
            "第14页 主卧 其他斗柜 209900200 01001北美黑胡桃木 尺寸 长：1300mm 宽：450mm 高：1000mm "
            "第19页 主卧 经典床头柜 3 209900200 01002北美黑胡桃木 尺寸 长：450mm 宽：400mm 高：500mm"
        )
        ...
        self.assertEqual(items[0]["product_code"], "20990020001001")
        self.assertEqual(items[0]["line_total"], "12400元")
        self.assertEqual(items[1]["product_name"], "经典床头柜")
        self.assertEqual(items[1]["product_code"], "20990020001002")
    ...
    def test_extract_product_line_items_prefers_local_ocr_table_block_for_detail(self) -> None:
        preview = (
            "第35页 合同内容 [OCR补充]"
            "<table><tr><td>演示城市A</td><td>主卧 其他床 209900300 03003</td>"
            "<td>北美黑胡桃木</td><td>尺寸 长：2132mm 宽：2067mm 高：1mm</td></tr>"
            "<tr><td>注明：</td><td colspan='4'>主卧黑胡桃2米标准款支腿架式床。</td></tr></table>"
            "<table><tr><td>演示城市A</td><td>主卧 经典床头柜 3 209900300 03004</td>"
    ...
    def test_extract_product_line_items_without_detail_page_keeps_empty_detail_snippet(self) -> None:
        preview = (
            ...
            "经典双屉书桌 20990010004004 北美樱桃木 1 3880 合计 15832 "
            ...
            assets=[
                JOB_MODELS.SourceAsset(
                    ...
                    text_preview=(
                        ...
                        "其他斗柜 20990020001001 北美黑胡桃木 1 12400 "
                        "经典床头柜 320990020001002 北美黑胡桃木 1 2580 合计 14980 "
                        "第14页 主卧 其他斗柜 209900200 01001北美黑胡桃木 无色哑光木蜡油尺寸 长：1300mm 宽：450mm 高：1000mm "
                        "第19页 主卧 经典床头柜 3 209900200 01002北美黑胡桃木 无色哑光木蜡油尺寸 长：450mm 宽：400mm 高：500mm"
                    ),

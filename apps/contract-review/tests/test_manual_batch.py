    ...
    def test_cli_writes_multi_product_split_output_for_multi_product_contract(self) -> None:
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            write_minimal_docx(
                raw_dir / "合同.docx",
                [
                    "附件： 产品名称 产品编号 材质 数量 费用合计（元） 其他斗柜 20260418001001 北美黑胡桃木 1 12400 经典床头柜 320260418001002 北美黑胡桃木 1 2580 合计 14980",
                    "主卧 其他斗柜 202604180 01001北美黑胡桃木 无色哑光木蜡油尺寸 长：1300mm 宽：450mm 高：1000mm",
                    "主卧 经典床头柜 3 202604180 01002北美黑胡桃木 无色哑光木蜡油尺寸 长：450mm 宽：400mm 高：500mm",
                ],
            )
            manifest = {
                "source_type": "manual_batch",
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            def fake_ocr_extractor(asset, *, source_path, job_dir, config):
                ...
                full_text = (
                    ...
                    "第18页 儿童房 经典带门书柜 202603500 04003北美樱桃木 尺寸 长：1800mm 宽：350mm 高：2100mm"
                )
                ...
                return {
                    ...
                    "status": "succeeded",
                    "backend": "paddleocr",
                    "text_preview": "经典带门书柜 20260350004003",
                    "full_text": full_text,
                    "text_extract_method": "paddleocr_pp_structurev3",
                    "output_dir": str(output_dir),
                    "markdown_path": str(markdown_path),

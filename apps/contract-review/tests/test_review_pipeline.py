        ...
        job = JOB_MODELS.ReviewJob(
            ...
            assets=[
                JOB_MODELS.SourceAsset(
                    ...
                    text_preview=(
                        "第1页 合同总金额为人民币8200元。"
                        " 第13页 附件：产品名称 产品编号 材质 数量 费用合计（元） 华夫格软包箱体床20260379009001 北美樱桃木 1 8200 合计 8200 折扣 100折 折扣后合计 8200。"
                        " 第14页 主卧 华夫格软包箱体床 20260379009001 北美樱桃木 尺寸 长：1560mm 宽：2120mm 高：1050mm。"
        ...
        job = JOB_MODELS.ReviewJob(
            ...
            assets=[
                JOB_MODELS.SourceAsset(
                    ...
                    text_preview=(
                        "第1页 合同总金额为人民币12545元。"
                        " 第13页 附件：产品名称 产品编号 材质 数量 费用合计（元） 支腿架式床20260426001001 北美黑胡桃木 1 12934 合计 12934 折扣 97折 折扣后合计 12545。"
                        " 第14页 主卧 支腿架式床 20260426001001 北美黑胡桃木 尺寸 长：2000mm 宽：1800mm 高：150mm。"
        ...
        job = JOB_MODELS.ReviewJob(
            ...
            assets=[
                JOB_MODELS.SourceAsset(
                    ...
                    text_preview=(
                        "第1页 合同总金额为人民币5000元。"
                        " 第13页 附件：产品名称 产品编号 材质 数量 费用合计（元） 新Y椅20260422006001 北美黑胡桃木 2 5000 合计 5000。"
                        " 第14页 客厅 新Y椅 20260422006001 北美黑胡桃木 尺寸 长：mm 宽：mm 高：mm 2 注明：黑胡桃新Y椅。"
                    ),
                    text_extract_method="pdf_text_layer",
                )
            ],
        ...
        job = JOB_MODELS.ReviewJob(
            ...
            assets=[
                JOB_MODELS.SourceAsset(
                    ...
                    text_preview=(
                        "第1页 合同总金额为人民币21611元。"
                        " 第13页 附件：产品名称 产品编号 材质 数量 费用合计（元） 定制组合书柜20260380003001 乌拉圭玫瑰木 1 24013 合计 24013 折扣 90折 折扣后合计 21611。"
                        " 第14页 书房 定制组合书柜 20260380003001 乌拉圭玫瑰木 尺寸 长：2165mm 宽：450mm 高：2500mm。"
                        " 第16页 外尺寸如图，玻璃为超白玻璃。"
                    ),
                    text_extract_method="pdf_text_layer",
                )
